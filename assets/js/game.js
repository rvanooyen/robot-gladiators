...
var fight = function(enemy) {
    ...
    while(playerInfo.health > 0 && enemy.health > 0) {
        if (isPlayerTurn) {
            ...
            // Subtract the value of 'playerInfo.attack' from the value of 'enemy.health' and use that result to update the value in the 'enemeyHealth' variable.
...
var startGame = function() {
    ...
    for (var i = 0; i < enemyInfo.length; i++) {
        if (playerInfo.health > 0) {
            ...
            // pass the pickedenemy.name variable's value into the fight function, where it will assume the value of the enemy.name pararmeter
...
// function to allow player to shop
var shop = function() {
